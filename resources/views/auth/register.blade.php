<x-layouts.guest>
    <x-slot:title>Create account - OnPageIQ</x-slot:title>
    <x-slot:heading>Create your account</x-slot:heading>
    <x-slot:subheading>Start with 5 free credits</x-slot:subheading>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div class="flex items-start">
            <input
                ...
                type="checkbox"
                required
                class="mt-1 size-4 rounded border-gray-300 dark:border-gray-700 text-primary-600 focus:ring-primary-600 dark:bg-gray-800"
            />
            <label for="terms" class="ml-3 block text-sm leading-6 text-gray-700 dark:text-gray-300">
                I agree to the
                <a href="#" class="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400">Terms of Service</a>
                and
                <a href="#" class="font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-400">Privacy Policy</a>
            </label>
        </div>
